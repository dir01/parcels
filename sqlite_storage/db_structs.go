...
func (r DBRawPostalApiResponse) ToBusinessModel() *core.PostalApiResponse {
	return &core.PostalApiResponse{
		ID:             r.ID,
		ApiName:        r.ApiName,
		...
		Status:         core.ApiResponseStatus(r.Status),
	}
}

func (r DBRawPostalApiResponse) FromBusinessModel(rawResp *core.PostalApiResponse) *DBRawPostalApiResponse {
	r.ID = rawResp.ID

...
// PostalApiMock implements core.PostalApi
type PostalApiMock struct {
	t minimock.Tester

	funcFetch          func(ctx context.Context, trackingNumber string) (pp1 *mm_core.PostalApiResponse)
	...
	funcParse          func(rawResponse *mm_core.PostalApiResponse) (tp1 *mm_core.TrackingInfo, err error)
	inspectFuncParse   func(rawResponse *mm_core.PostalApiResponse)
	afterParseCounter  uint64
	beforeParseCounter uint64
	ParseMock          mPostalApiMockParse
}

// NewPostalApiMock returns a mock for core.PostalApi
...
func (mmFetch *mPostalApiMockFetch) Return(pp1 *mm_core.PostalApiResponse) *PostalApiMock {
	if mmFetch.mock.funcFetch != nil {
		mmFetch.mock.t.Fatalf("PostalApiMock.Fetch mock is already set by Set")
	}
...
func (mmFetch *mPostalApiMockFetch) Set(f func(ctx context.Context, trackingNumber string) (pp1 *mm_core.PostalApiResponse)) *PostalApiMock {
	if mmFetch.defaultExpectation != nil {
...
func (e *PostalApiMockFetchExpectation) Then(pp1 *mm_core.PostalApiResponse) *PostalApiMock {
	e.results = &PostalApiMockFetchResults{pp1}
	return e.mock
}

// Fetch implements core.PostalApi
func (mmFetch *PostalApiMock) Fetch(ctx context.Context, trackingNumber string) (pp1 *mm_core.PostalApiResponse) {
...
type PostalApiMockParseParams struct {
	rawResponse *mm_core.PostalApiResponse
}

// PostalApiMockParseResults contains results of the PostalApi.Parse
type PostalApiMockParseResults struct {
	tp1 *mm_core.TrackingInfo
	err error
}

// Expect sets up expected params for PostalApi.Parse
func (mmParse *mPostalApiMockParse) Expect(rawResponse *mm_core.PostalApiResponse) *mPostalApiMockParse {
...
func (mmParse *mPostalApiMockParse) Inspect(f func(rawResponse *mm_core.PostalApiResponse)) *mPostalApiMockParse {
...
func (mmParse *mPostalApiMockParse) Return(tp1 *mm_core.TrackingInfo, err error) *PostalApiMock {
	if mmParse.mock.funcParse != nil {
		mmParse.mock.t.Fatalf("PostalApiMock.Parse mock is already set by Set")
	}
...
func (mmParse *mPostalApiMockParse) Set(f func(rawResponse *mm_core.PostalApiResponse) (tp1 *mm_core.TrackingInfo, err error)) *PostalApiMock {
	if mmParse.defaultExpectation != nil {
...
// Then helper
func (mmParse *mPostalApiMockParse) When(rawResponse *mm_core.PostalApiResponse) *PostalApiMockParseExpectation {
	if mmParse.mock.funcParse != nil {
		mmParse.mock.t.Fatalf("PostalApiMock.Parse mock is already set by Set")
	}
...
func (e *PostalApiMockParseExpectation) Then(tp1 *mm_core.TrackingInfo, err error) *PostalApiMock {
	e.results = &PostalApiMockParseResults{tp1, err}
	return e.mock
}

// Parse implements core.PostalApi
func (mmParse *PostalApiMock) Parse(rawResponse *mm_core.PostalApiResponse) (tp1 *mm_core.TrackingInfo, err error) {
